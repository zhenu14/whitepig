package com.feature.demo.chapter2.parameterize.apple.attempt2;
...
public class AppleFilter {
    ...
    public static void main(String[] args){
        ...
        List<Apple> temp1 = filterApples(apples, new ApplePredicate() {
            public boolean filter(Apple apple) {
                return "red".equals(apple.getColor());
            }
        });
        System.out.println(temp1);
        List<Apple> temp2 = filterApples(apples, new ApplePredicate() {
            public boolean filter(Apple apple) {
